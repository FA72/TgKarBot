namespace TgKarBot.Constants
{
    internal class Messages
    {
        ...
        internal const string Start = $"Кар! \n" +
                                      $"Квест начинается 23.09.2022 в 19:30 у станции метро Сенная площадь. Время вашего старта считается с ввода команды /startgame. Отыгрыш продлится до 23:59 24.09.2022. После времени окончания квеста ответы приниматься не будут.\r\n\r\n" +
                                      ...
                                      $"/regteam — зарегистрировать команду. Перед тем, как начать игру, введите эту команду в формате /regteam [номер команды]. Номер команды вам должны были предоставить организаторы, если этого не произошло свяжитесь с нами через команду /support. Пример:.\r\n\r\n" +
                                      $"\r\n/regteam 12345" +
                                      ...
                                      $"Готовы начинать? Тогда вводите команду /startgame и вперёд!";
    }
}
