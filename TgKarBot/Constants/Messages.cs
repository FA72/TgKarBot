...
internal class Messages
{
    ...
    internal const string GameGlobalStart = "Всем привет! Игра начинается, вы можете ввести команду /startgame для начала игры. " +
                                            "После этого вы получите задания и начнётся отсчёт времени. Поэтому рекомендуем вам начинать  у Казгосцирка (пр. Абая, 50)";
    ...
    internal static string Start = $"Кар! \n" +
                                  ...
                                  $"Квест \"Pub Crow\" начинается 12.09.2025 в 19:00 у Казгосцирка, пр. Абая, 50. Время вашего старта считается с ввода команды /startgame. Отыгрыш продлится до 23:59 12.09.2025. Обратите внимание, что некоторые заведения могут работать до 23:00. После времени окончания квеста ответы приниматься не будут.\r\n\r\n" +
                                  $"Впереди 10 основных вопросов и несколько бонусных заданий. Выдаваться основные вопросы будут по два. После ответа на один из них будет ставиться пауза, которая не будет снята до ответа на второй вопрос из пары или его пропуска (см. /next). Ответы на бонусные задания можно сдавать в любом порядке до взятия последнего по счёту основного. \r\n\r\n" +
                                  ...
                                  $"Пожалуйста, проходите квест всей командой, не разделяясь.\r\n\r\n" +
                                  ...
                                  $"/startgame — начать игру и отсчёт вашего времени. Ввести команду можно после 19:00 пятницы (12.09). Прежде чем вводить команду, проверьте, что вы находитесь у Казгосцирка, пр. Абая, 50. Помните, что специально остановить таймер нельзя!\r\n\r\n" +
