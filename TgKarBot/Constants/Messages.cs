namespace TgKarBot.Constants
{
    internal class Messages
    {
        ...
        internal const string Start = $"Кар! \n" +
                                      ...
                                      $"\r\n/regteam 45554\r\n\r\n" +
                                      $"/startgame — начать игру и отсчёт вашего времени. Ввести команду можно после 19:00 пятницы (22.09). Прежде чем вводить команду, проверьте, что вы находитесь у метро Сенная площадь и помните, что остановить таймер нельзя.\r\n\r\n" +
