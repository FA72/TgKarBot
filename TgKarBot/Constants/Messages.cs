...
internal class Messages
{
    ...
    internal static string Start = $"Кар! \n" +
                                  ...
                                  $"Квест \"Pub Crow\" начинается 20.09.2024 в 19:00 у памятника Виктору Цою (ул. М. Тулебаева). Время вашего старта считается с ввода команды /startgame. Отыгрыш продлится до 23:59 21.09.2024. Обратите внимание, что многие бары работают до 23:00. После времени окончания квеста ответы приниматься не будут.\r\n\r\n" +
                                  ...
                                  $"/startgame — начать игру и отсчёт вашего времени. Ввести команду можно после 19:00 пятницы (20.09). Прежде чем вводить команду, проверьте, что вы находитесь у памятника Виктору Цою. Помните, что специально остановить таймер нельзя!\r\n\r\n" +
