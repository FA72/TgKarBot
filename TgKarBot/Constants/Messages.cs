...
internal class Messages
{
    ...
    internal const string GameGlobalStart = "Всем привет! Игра начинается, вы можете ввести команду /startgame для начала игры. " +
                                            "После этого вы получите задания и начнётся отсчёт времени. Поэтому рекомендуем вам начинать у м. Василеостровская.";
    ...
    internal static string Start = $"Кар! \n" +
                                  ...
                                  $"Квест \"Pub Crow\" начинается в 19:00, в пятницу 12 сентября, у м. Василеостровская. Время вашего старта считается с ввода команды /startgame. Отыгрыш продлится до 23:59 13.09.2025. Обратите внимание, что многие бары работают до 23:00. После времени окончания квеста ответы приниматься не будут.\r\n\r\n" +
                                  $"Впереди 10 основных вопросов и несколько бонусных заданий. Каждый основной вопрос - отдельное новое место, бонусные задания выполняются в том же месте, где основные с тем же номером. Выдаваться основные вопросы будут по два, но отвечать на них можно в любом порядке. После правильного ответа на один из них будет ставиться пауза, которая не будет снята до ответа на второй вопрос из пары или его пропуска (см. /next). Ответы на бонусные задания можно сдавать в любом порядке до взятия последнего по счёту основного. \r\n\r\n" +
                                  ...
                                  $"/regteam — зарегистрировать команду. Перед тем, как начать игру, введите эту команду в формате /regteam [названиекоманды]. Прошу вас вводить именно то название, которое было в регистрационной форме без пробелов, чтобы позднее мы могли вас отличить. Пример:" +
                                  $"\r\n/regteam Утканавороне\r\n\r\n" +
                                  $"/startgame — начать игру и отсчёт вашего времени. Ввести команду можно после 19:00 пятницы (12.09). Прежде чем вводить команду, проверьте, что вы находитесь у м. Василеостровская, и помните, что остановить таймер нельзя.\r\n\r\n" +
                                  $"/ask — ввести ответ на вопрос. Ответы вводятся в формате ask [номер вопроса] [ответ]. Примеры:\r\n" +
                                  $"/ask 0 nevermore\r\n" +
                                  $"/ask бонус0 кар\r\n\r\n" +
                                  $"/next — После правильного ответа на второй вопрос в паре вы также можете выпить в баре. Следующая пара вопросов не появится до введения команды /next. После введения этой команды будет запущен таймер. Вы можете ввести эту команду до прохождения второго вопроса пары. В таком случае пауза будет снята, время пойдёт, но вы всё ещё сможете ответить на второй вопрос пары в будущем (НО ПРИ ЭТОМ ПАУЗА УЖЕ СТАВИТЬСЯ НЕ БУДЕТ) \r\n\r\n" +
