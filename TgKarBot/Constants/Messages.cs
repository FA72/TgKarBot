namespace TgKarBot.Constants
{
    internal class Messages
    {
        ...
        internal const string Start = $"Кар! \n" +
                                      ...
                                      $"Квест \"Pub Crow\" начинается 22.09.2023 в 19:30 у станции метро Сенная площадь. Время вашего старта считается с ввода команды /startgame. Отыгрыш продлится до 23:59 24.09.2022. После времени окончания квеста ответы приниматься не будут.\r\n\r\n" +
